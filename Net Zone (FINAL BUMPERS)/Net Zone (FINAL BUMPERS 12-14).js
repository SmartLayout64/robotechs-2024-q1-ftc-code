...
function Push_Yellow_Samples() {
  ...
  moveWithVectors(-0.3, 0, 0.7);
  moveWithVectors(0, -0.4, 1);
  turn(-0.5, 0.25);
  moveWithVectors(0, -0.4, 0.9);
  moveWithVectors(0, 0.4, 0.9);
  turn(0.5, 0.25);
  moveWithVectors(0, 0.4, 1.1);
  moveWithVectors(-0.2, 0, 1.35);
  moveWithVectors(0, -0.4, 1.9);
  moveWithVectors(0, 0.4, 1.9);
  moveWithVectors(-0.35, 0, 0.47);
  moveWithVectors(0, -0.4, 1.95);
  moveWithVectors(-0.4, 0.4, 0.5);
}
